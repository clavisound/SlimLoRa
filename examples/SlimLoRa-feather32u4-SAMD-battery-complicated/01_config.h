 ...
 */
  ...
  #ifdef HLM
  uint8_t DevEUI[8]             = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; // NO WEB 0006110091121008 copied from broken ztubea
  //uint8_t /*AppEUI*/ JoinEUI[8] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; // NO WEB
  uint8_t /*AppEUI*/ JoinEUI[8] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; // NO WEB
  uint8_t AppKey[16]            = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; // NO WEB EBD7C5B0B833A2307B4EFB239C45FCD9
  // For LoRaWAN-1.1
